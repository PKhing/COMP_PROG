...
class Ship(pg.sprite.Sprite):
    def __init__(self,color, width, height):
        ...
        self.image = pg.image.load("Workshop/Workshop10-Pygame2/source/img/Ship.png")
...
class Meteor(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("Workshop/Workshop10-Pygame2/source/img/meteor_med.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    pg.sprite.spritecollide(myShip,meteor_sprites,True)
